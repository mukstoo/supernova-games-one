...
export const enemies: Enemy[] = [
  makeEnemy('enemy-1', 'Brute',   { str: 2, spd: 1, smr: 1, stm: 1 }),
  makeEnemy('enemy-2', 'Scout',   { str: 1, spd: 2, smr: 1, stm: 1 }),
  makeEnemy('enemy-3', 'Mage',    { str: 1, spd: 1, smr: 2, stm: 1 }),
  makeEnemy('enemy-4', 'Tank',    { str: 1, spd: 1, smr: 1, stm: 2 }),
];
